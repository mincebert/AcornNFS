...
.L963C
LDA #&04
BIT &FE4D:BNE L9646    :\ VIA interupt for Remote Call, jump to process
...
LDA &FE4B:AND #&E3
ORA &0D51:STA &FE4B    :\ Restore System VIA settings
LDA &FE4A              :\ Read shift register to clear it
LDA #&04:STA &FE4D     :\ Clear shift register interupt
STA &FE4E              :\ Disable shift register interupt
...
LDA #&80:STA &0D62
STA &0D66
LDA &FE18:STA &0D22       :\ Put station number in NMI code
STY &0D23:STY &98
BIT &FE20                 :\ Enable ALDC NMIs
RTS

\ Continuation of NMI code
.L96BF
LDA #&01
BIT &FEA1:BEQ L96FE      :\ Not start of frame
LDA &FEA2                :\ Get first data byte
CMP &FE18:BEQ L96D7      :\ Dest=me
...
LDA &FEA2       :\ 96E1= AD A2 FE    -"~
BEQ L96F2       :\ 96E4= F0 0C       p.
EOR #&FF        :\ 96E6= 49 FF       I.
BEQ L96F5       :\ 96E8= F0 0B       p.
.L96EA
LDA #&A2:STA &FEA0    :\ Ignore this frame
JMP L99EB
...
.L9810
BIT &FEA1       :\ 9810= 2C A1 FE    ,!~
BPL L9835       :\ 9813= 10 20       . 
LDA &FEA2       :\ 9815= AD A2 FE    -"~
LDA &FEA2       :\ 9818= AD A2 FE    -"~
.L981B
LDA #&02        :\ 981B= A9 02       ).
...
.L9843
LDY &A2         :\ 9843= A4 A2       $"
LDA &FEA1       :\ 9845= AD A1 FE    -!~
.L9848
BPL L9877       :\ 9848= 10 2D       .-
LDA &FEA2       :\ 984A= AD A2 FE    -"~
STA (&A4),Y     :\ 984D= 91 A4       .$
INY             :\ 984F= C8          H
...
.L9858
LDA &FEA1       :\ 9858= AD A1 FE    -!~
BMI L985F       :\ 985B= 30 02       0.
BNE L9877       :\ 985D= D0 18       P.
.L985F
LDA &FEA2       :\ 985F= AD A2 FE    -"~
STA (&A4),Y     :\ 9862= 91 A4       .$
INY             :\ 9864= C8          H
STY &A2         :\ 9865= 84 A2       ."
...
.L98A0
LDA &FEA1       :\ 98A0= AD A1 FE    -!~
.L98A3
BPL L98C3       :\ 98A3= 10 1E       ..
LDA &FEA2       :\ 98A5= AD A2 FE    -"~
JSR L9A37       :\ 98A8= 20 37 9A     7.
BEQ L988E       :\ 98AB= F0 E1       pa
STA &FEE5       :\ 98AD= 8D E5 FE    .e~
LDA &FEA2       :\ 98B0= AD A2 FE    -"~
STA &FEE5       :\ 98B3= 8D E5 FE    .e~
JSR L9A37       :\ 98B6= 20 37 9A     7.
BEQ L98C3       :\ 98B9= F0 08       p.
LDA &FEA1       :\ 98BB= AD A1 FE    -!~
BNE L98A3       :\ 98BE= D0 E3       Pc
JMP &0D14       :\ 98C0= 4C 14 0D    L..
 
.L98C3
LDA #&00        :\ 98C3= A9 00       ).
STA &FEA0       :\ 98C5= 8D A0 FE    . ~
LDA #&84        :\ 98C8= A9 84       ).
STA &FEA1       :\ 98CA= 8D A1 FE    .!~
LDA #&02        :\ 98CD= A9 02       ).
BIT &FEA1       :\ 98CF= 2C A1 FE    ,!~
...
.L9925 
LDA &FE18       :\ 9925= AD 18 FE    -.~
BIT &FEA0       :\ 9928= 2C A0 FE    , ~
BVC L994B       :\ 992B= 50 1E       P.
STA &FEA2       :\ 992D= 8D A2 FE    ."~
LDA #&00        :\ 9930= A9 00       ).
STA &FEA2       :\ 9932= 8D A2 FE    ."~
LDA &0D4A       :\ 9935= AD 4A 0D    -J.
BMI L9948       :\ 9938= 30 0E       0.
LDA #&3F        :\ 993A= A9 3F       )?
STA &FEA1       :\ 993C= 8D A1 FE    .!~
...
LDA #&84        :\ 9B03= A9 84       ).
STA &FE4E       :\ 9B05= 8D 4E FE    .N~
LDA &FE4B       :\ 9B08= AD 4B FE    -K~
AND #&1C        :\ 9B0B= 29 1C       ).
STA &0D51       :\ 9B0D= 8D 51 0D    .Q.
LDA &FE4B       :\ 9B10= AD 4B FE    -K~
AND #&E3        :\ 9B13= 29 E3       )c
ORA #&08        :\ 9B15= 09 08       ..
STA &FE4B       :\ 9B17= 8D 4B FE    .K~
BIT &FE4A       :\ 9B1A= 2C 4A FE    ,J~
.L9B1D
...
.L9CF6
LDA #&67        :\ 9CF6= A9 67       )g
STA &FEA1       :\ 9CF8= 8D A1 FE    .!~
LDA #&41        :\ 9CFB= A9 41       )A
.L9CFD
LDY &FE18       :\ 9CFD= AC 18 FE    ,.~
.L9D00
PHA             :\ 9D00= 48          H
PLA             :\ 9D01= 68          h
INY             :\ 9D02= C8          H
...
.L9DA3
LDA &FE18       :\ 9DA3= AD 18 FE    -.~
BIT &FEA0       :\ 9DA6= 2C A0 FE    , ~
BVC L9DCD       :\ 9DA9= 50 22       P"
STA &FEA2       :\ 9DAB= 8D A2 FE    ."~
LDA #&00        :\ 9DAE= A9 00       ).
STA &FEA2       :\ 9DB0= 8D A2 FE    ."~
.L9DB3
LDA #&02        :\ 9DB3= A9 02       ).
...
.L9DC8
LDY &A2         :\ 9DC8= A4 A2       $"
BIT &FEA0       :\ 9DCA= 2C A0 FE    , ~
.L9DCD
BVC L9E48       :\ 9DCD= 50 79       Py
LDA (&A4),Y     :\ 9DCF= B1 A4       1$
STA &FEA2       :\ 9DD1= 8D A2 FE    ."~
INY             :\ 9DD4= C8          H
...
LDA &FEE5       :\ 9E14= AD E5 FE    -e~
STA &FEA2       :\ 9E17= 8D A2 FE    ."~
INC &A2         :\ 9E1A= E6 A2       f"
...
.L9E2A
LDA &FEE5       :\ 9E2A= AD E5 FE    -e~
STA &FEA2       :\ 9E2D= 8D A2 FE    ."~
INC &A2         :\ 9E30= E6 A2       f"
...
.L9E84
BIT &FEA1       :\ 9E84= 2C A1 FE    ,!~
BPL L9EAC       :\ 9E87= 10 23       .#
LDA &FEA2       :\ 9E89= AD A2 FE    -"~
CMP &0D20       :\ 9E8C= CD 20 0D    M .
BNE L9EAC       :\ 9E8F= D0 1B       P.
LDA &FEA2       :\ 9E91= AD A2 FE    -"~
...
LDA #&00:STA &FEA1
.L9F4C
LDA #&82:STA &FEA0     :\ Put ALDC into standby
LDA #&67:STA &FEA1
RTS
...
\ ----------------------------------------------------------- 
.L9F57
BIT &0D66:BPL L9F7A    :\ I'm not using NMIs, put stand ALDC down and return
.L9F5C
...
.L9F7A
JMP L9F4C              :\ Jump to stand ALDC down and return

\ Background NMI code 
.L9F7D
BIT &FE18          :\ 0D00 Disable ALDC NMIs
PHA:TYA:PHA        :\ 0D03 Save registers
LDA #&00:STA &FE30 :\ 0D06 Select NFS ROM
JMP L96BF          :\ 0D0B Jump to rest of code
 
.L9D8B
STY &0D0D          :\ 0D0E Store next NMI routine
STA &0D0C          :\ 0D11
LDA &F4:STA &FE30  :\ 0D14 Restore ROM
PLA:TAY:PLA        :\ 0D19 Restore registers
BIT &FE20          :\ 0D1C Enable ALDC NMIs
RTI                :\ 0D1F
