...
CPY #&00:BEQ L8183
LDX #&06:LDA #&14:JSR OSBYTE
.L8134
BIT &FEE0       :\ 8134= 2C E0 FE    ,`~
BPL L8134       :\ 8137= 10 FB       .{
LDA &FEE1       :\ 8139= AD E1 FE    -a~
BEQ L8181       :\ 813C= F0 43       pC
JSR OSWRCH      :\ 813E= 20 EE FF     n.
JMP L8134       :\ 8141= 4C 34 81    L4.
 
.L8144
LDA #&AD        :\ 8144= A9 AD       )-
STA &0220       :\ 8146= 8D 20 02    . .
LDA #&06        :\ 8149= A9 06       ).
STA &0221       :\ 814B= 8D 21 02    .!.
LDA #&16        :\ 814E= A9 16       ).
STA &0202       :\ 8150= 8D 02 02    ...
LDA #&00        :\ 8153= A9 00       ).
STA &0203       :\ 8155= 8D 03 02    ...
LDA #&8E        :\ 8158= A9 8E       ).
STA &FEE0       :\ 815A= 8D E0 FE    .`~
LDY #&00        :\ 815D= A0 00        .
.L815F
LDA L9362+&000,Y :\ 815F= B9 62 93    9b.
STA &0400,Y      :\ 8162= 99 00 04    ...
LDA L9362+&100,Y :\ 8165= B9 62 94    9b.
STA &0500,Y      :\ 8168= 99 00 05    ...
LDA L9362+&200,Y :\ 816B= B9 62 95    9b.
STA &0600,Y     :\ 816E= 99 00 06    ...
DEY             :\ 8171= 88          .
BNE L815F       :\ 8172= D0 EB       Pk
JSR &0421       :\ 8174= 20 21 04     !.
LDX #&60        :\ 8177= A2 60       "`
.L8179
LDA L9321,X     :\ 8179= BD 21 93    =!.
STA &16,X       :\ 817C= 95 16       ..
DEX             :\ 817E= CA          J
BPL L8179       :\ 817F= 10 F8       .x
.L8181
LDA #&00        :\ 8181= A9 00       ).
...
.L829A
EQUW &FF1B      :\ 829A= 1B FF       ..
ASL &21FF,X     :\ 829C= 1E FF 21    ..!
EQUB &FF        :\ 829F= FF          .
BIT &FF         :\ 82A0= 24 FF       $.
EQUB &27        :\ 82A2= 27          '
EQUB &FF        :\ 82A3= FF          .
ROL A           :\ 82A4= 2A          *
EQUB &FF        :\ 82A5= FF          .
AND &0CFF       :\ 82A6= 2D FF 0C    -..  870C - FILE
EQUB &87        :\ 82A9= 87          .
LSR A           :\ 82AA= 4A          J
PLA             :\ 82AB= 68          h    8968 - ARGS
EQUW &4489      :\ 82AC= 89 44       .D
EQUB &63        :\ 82AE= 63          c
STA &57         :\ 82AF= 85 57       .W   8563 - BGET
EQUB &13        :\ 82B1= 13          .
STY &42         :\ 82B2= 84 42       .B   8413 - BPUT
EQUW &8A72      :\ 82B4= 72 8A       r.   8A72 - GBPB
EOR (&D8,X)     :\ 82B6= 41 D8       AX
EQUW &5289      :\ 82B8= 89 52       .R   89D8 - FIND
EQUB &D4        :\ 82BA= D4          T
EQUB &80        :\ 82BB= 80          .    80D4 - FSC
...
.L90A4
SBC &E9,X       :\ 90A4= F5 E9       ui
SBC #&E9        :\ 90A6= E9 E9       ii
LDA &DA,X       :\ 90A8= B5 DA       5Z
SBC &E7,X       :\ 90AA= F5 E7       ug
EQUB &53        :\ 90AC= 53          S
.L90AD
EQUW &9180      :\ 90AD= 80 91       ..
 
.L90AF
STA (&91),Y     :\ 90AF= 91 91       ..
BCC L9044       :\ 90B1= 90 91       ..
EQUW &9080      :\ 90B3= 80 90       ..
...
.L9321
LDA #&FF        :\ 9321= A9 FF       ).
JSR &069E       :\ 9323= 20 9E 06     ..
LDA &FEE3       :\ 9326= AD E3 FE    -c~
LDA #&00        :\ 9329= A9 00       ).
JSR &0695       :\ 932B= 20 95 06     ..
TAY             :\ 932E= A8          (
LDA (&FD),Y     :\ 932F= B1 FD       1}
JSR &0695       :\ 9331= 20 95 06     ..
.L9334
INY             :\ 9334= C8          H
LDA (&FD),Y     :\ 9335= B1 FD       1}
JSR &0695       :\ 9337= 20 95 06     ..
TAX             :\ 933A= AA          *
BNE L9334       :\ 933B= D0 F7       Pw
LDX #&FF        :\ 933D= A2 FF       ".
TXS             :\ 933F= 9A          .
CLI             :\ 9340= 58          X
.L9341
BIT &FEE0       :\ 9341= 2C E0 FE    ,`~
BPL L934C       :\ 9344= 10 06       ..
.L9346
LDA &FEE1       :\ 9346= AD E1 FE    -a~
JSR OSWRCH      :\ 9349= 20 EE FF     n.
.L934C
BIT &FEE2       :\ 934C= 2C E2 FE    ,b~
BPL L9341       :\ 934F= 10 F0       .p
BIT &FEE0       :\ 9351= 2C E0 FE    ,`~
BMI L9346       :\ 9354= 30 F0       0p
LDX &FEE3       :\ 9356= AE E3 FE    .c~
STX &51         :\ 9359= 86 51       .Q
JMP (&0500)     :\ 935B= 6C 00 05    l..
 
BRK             :\ 935E= 00          .
EQUW &0080      :\ 935F= 80 00       ..
