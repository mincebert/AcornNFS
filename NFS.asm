...
AND #&DF     ; 8C2F 29 DF       )�   Ignore case
BEQ L8C26    ; 8C31 F0 F3       ��   Matches, loop for another char
DEX          ; 8C33 CA          �    Doesn't match
.L8C34
INX          ; 8C34 E8          �    
LDA L8C4B+0,X ; 8C35 BD 4B 8C    �K.  
BPL L8C34     ; 8C38 10 FA       .�   Loop for end of entry
LDA (&BE),Y   ; 8C3A B1 BE       ��   Get command line character
INX           ; 8C3C E8          �    
CMP #&2E      ; 8C3D C9 2E       �.   Is it abbreviated?
BNE L8C24     ; 8C3F D0 E3       ��   No, loop back to check next entry
INY           ; 8C41 C8          �    
DEX           ; 8C42 CA          �    
BCS L8C28     ; 8C43 B0 E3       ��   Abbreviated, jump to get address byte and jump back here
.L8C45
